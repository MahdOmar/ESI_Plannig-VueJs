<template>
  <div
    class="container-fluid bg-custom"
    style="padding-left: 60px; height: 800px"
  >
    <nav
      class="
        navbar
...
export default {
  ...
  methods: {
    ...
    getsemesters() {
      ...
      axios
        .post(API_URL + "getsemesters", { yearid: this.selected })
        .then((res) => {
    ...
    getSections() {
      ...
      axios
        .post(API_URL + "getsections", { year: this.selected })
        .then((res) => {
    ...
    getGroupes() {
      ...
      axios
        .post(API_URL + "getgroups", { section: this.selectSec })
        .then((res) => {
    ...
    getPlanning() {
      ...
      axios
        .post(API_URL + "getplanning", {
          semester: this.selectSem,
          group: this.selectGrp,
        })
        .then((res) => {
