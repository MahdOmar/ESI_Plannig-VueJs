  ...
  <div>
    <div class="d-flex justify-content-between">
      ...
      <button
        type="button"
        data-toggle="modal"
        data-target="#add_cour"
        style="float: right"
        class="btn btn-primary btn-sm m-2"
      >
        <i class="fa fa-fw fa-plus"></i>Ajouter Cours/TD/TP
      </button>
    </div>
...
export default {
  ...
  methods: {
    ...
    editCour() {
      ...
      axios
        .post(
          API_URL + "admin/updatetdp_cours",
          {
            hour: this.courE.hour,

            min: this.courE.min,
            requirement: this.courE.requirementId,
            type: this.courE.type,
            id: this.courE.id,
          },
          { headers: headers }
        )
    ...
    getcours() {
      ...
      axios
        .post(
          API_URL + "admin/getcours",
          { module: this.moduleid.id },
          { headers: headers }
        )
        .then((res) => {
