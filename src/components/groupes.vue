<template>
    ...
    <div>
        ...
        <button type="button"  data-toggle="modal" data-target="#add_groupe" style="float: right" class="btn btn-primary btn-sm m-2"><i class="fa fa-fw fa-plus"></i>Ajouter Groupe </button>
          ...
          <table class="table bg-white">
            ...
            <tbody>
               ...
               <tr v-for="groupe in groupes" :key="groupe.id">
                    ...
                    <td>
                        <button type="button" title="Editer" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#edit_groupe"  @click="getGroupe(groupe)"><i class="fa fa-fw fa-edit"></i></button>
                        <button type="button" title="Supprimer" class="btn btn-danger btn-sm" @click="deletegroupe(groupe)"><i class="fa fa-fw fa-trash"></i></button>
