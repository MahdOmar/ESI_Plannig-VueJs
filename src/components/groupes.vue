  ...
  <div>
    <div class="d-flex justify-content-between">
      ...
      <button
        type="button"
        data-toggle="modal"
        data-target="#add_groupe"
        style="float: right"
        class="btn btn-primary btn-sm m-2"
      >
        <i class="fa fa-fw fa-plus"></i>Ajouter Groupe
      </button>
    </div>
        ...
        <tr v-for="groupe in groupes" :key="groupe.id">
          ...
          <td>
            <button
              ...
              data-toggle="modal"
              data-target="#edit_groupe"
              @click="getGroupe(groupe)"
            >
...
export default {
  ...
  methods: {
    addGroupe() {
      ...
      axios
        .post(
          API_URL + "admin/addgroup",
          {
            section: this.section.id,
            name: this.groupeName,
          },
          { headers: headers }
        )
        .then((res) => {
    ...
    editGroupe() {
      ...
      axios
        .post(
          API_URL + "admin/updategroup",
          {
            id: this.groupeNameE.id,
            name: this.groupeNameE.name,
          },
          { headers: headers }
        )
        .then((res) => {
