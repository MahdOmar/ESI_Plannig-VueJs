...
export default{
 ...
 computed: mapGetters({
    ...
    methods: {
      ...
      axios.post(API_URL + 'admin/updatesection', {

       id:this.sectionId , name:this.sectionNameE.name } ,{ headers : headers}
         ...
         const headers = {
          ...
          Swal.fire({
            ...
            if (result.value) {
                  ...
                  axios.post(API_URL + 'admin/deletesection', { id:section.id
