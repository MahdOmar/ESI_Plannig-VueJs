...
export default {
  ...
  methods: {
      async example(){
          try {
            ...
            'Authorization': 'Bearer '+this.token
              ...
              var res = await axios.post(API_URL + 'prof/generalplanning', { id:this.user.id } ,{ headers : headers});
     ...
     async   getplanning(){
      ...
      await axios.post(API_URL + 'prof/generalplanning', { id:this.user.id } ,{ headers : headers}
...
/*var that = this
  ...
  setTimeout(function(){
     that.addCour();
      that.day1 = that.days[1]
      that.day2 = that.days[2]
      that.day3 = that.days[3]
      that.day4 = that.days[4]
      that.day5 = that.days[5]
