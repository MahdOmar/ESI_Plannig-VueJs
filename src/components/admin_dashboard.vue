          ...
          <div class="_1side_menu_list">
            <ul class="_1side_menu_list_ul">
              <div v-if="user.role === 0">
                ...
                <li class="item font-weight-bold" style="color: #0066ff">
                  Enseignants
                </li>
                <li class="custom">
                  <router-link to="/dashboard/users"
                    ><i class="fas fa-users"></i> Gestion des
                ...
                <li>
                  <a
                    ...
                    ><i class="fas fa-calendar-plus"></i> Nouveau Emploi du
                    Temps</a
                  >
                  <ul class="collapse list-unstyled" id="drop">
                    <li>
                      <router-link to="/dashboard/manual"
                        ><i class="fas fa-puzzle-piece"></i> Semestrielle
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/dashboard/exam_planning_generation"
                        ><i class="fas fa-puzzle-piece"></i> Examens
                      </router-link>
                    </li>
                  </ul>
                </li>
                ...
                <li>
                  <router-link to="/dashboard/entities"
                    ><i class="fas fa-calendar-plus"></i> Definir les
                    Modules</router-link
                  >
                </li>

                <li class="item font-weight-bold" style="color: #0066ff">
                  Gestion des Lieux d'étude
                </li>
                <li>
                  <router-link to="/dashboard/requirements"
                    ><i class="fas fa-calendar-plus"></i> Definir les Lieux
                    d'étude</router-link
                  >
                </li>
                ...
                <li>
                  <router-link to="/dashboard/sections-groupes"
                    ><i class="fas fa-calendar-plus"></i> Definir les Sections /
                    Groupes</router-link
                  >
                </li>
              </div>
              <div v-if="user.role === 1">
                ...
                <li>
                  <router-link to="/dashboard/plannings">
                    <i class="fas fa-table"></i>Mes Emplois</router-link
                  >
                </li>
                <li>
                  <router-link to="/dashboard/g_planning"
                    ><i class="fas fa-table"></i>Mon Emploi du temps Générale
                  </router-link>
                </li>
            ...
            <ul class="d-flex">
              <li class="user-img">
                <img
                  ...
                  style="height: 35px; width: 35px; align-self: center"
                />
              </li>
              ...
              <li class="username">
                <a
                  ...
                  data-toggle="collapse"
                  aria-expanded="false"
                  class="dropdown-toggle text-white text-capitalize"
                >
                  {{ user.username }}
                </a>
                <p
